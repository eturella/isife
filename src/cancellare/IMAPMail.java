...
public final class IMAPMail {
	...
	public static void main(String[] args) {
		...
		String proto = "SSL"; // (args.length > 3) ? args[3] : null;
		...
		imap.addProtocolCommandListener(new PrintCommandListener(System.out,
				true));
		...
		try {
			...
			imap.fetch("4", "BODY[TEXT]");
			res = imap.getReplyString();
